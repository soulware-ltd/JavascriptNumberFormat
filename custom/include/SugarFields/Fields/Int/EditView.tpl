...
{literal}
$(function(){
	var id = {/literal}'{{if empty($displayParams.idName)}}{{sugarvar key='name'}}{{else}}{{$displayParams.idName}}{{/if}}'{literal};
	var disable_num_format = {/literal}{{$displayParams.disable_num_format}}{literal};	
	if(disable_num_format != 1) SWNumberFormatUtils.set_int_format_listeners(id);
});
{/literal}
</script>
